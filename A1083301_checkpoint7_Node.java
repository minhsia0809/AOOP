...
public class A1083301_checkpoint7_Node {
    private A1083301_checkpoint7_Node Next;
    // axis: 0 --> x
    //       1 --> y
    ...
    private int axis;
    public A1083301_checkpoint7_Node(int direction, int axis){
    ...
    public void setNext(A1083301_checkpoint7_Node Next){
        //TODO(6) set the Next via this function.

        this.Next = Next;

    }
    public A1083301_checkpoint7_Node getNext(){
